...
class VnExpressSpiderMiddleware(object):
    ...
    def spider_opened(self, spider):
        try:
            ...
            if self.collection_name in colllist:
                ...
                query = {'domain': 'shop.vnexpress.net'}
    ...
    def process_request(self, request, spider):
        ...
        try:
            if len(self.blacklinks) > 0:
                ...
                spider.logger.info(
                    'ShopVnExpress blacklinks have no any records.')
        except Exception as ex:
            spider.logger.error(
                'ShopVnExpress spider process_request errors: {}'.format(ex))
