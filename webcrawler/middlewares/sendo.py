...
class SendoSpiderMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        try:
            if len(self.blacklinks) > 0:
                ...
                spider.logger.info('Sendo blacklinks have no any records.')
        except Exception as ex:
            spider.logger.error(
                'Sendo spider process_request errors: {}'.format(ex))
